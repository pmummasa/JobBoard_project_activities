...
public class Activity_13 {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] heading = {"ID", "Your email", "Job Title", "Location", "Description", "Application email/URL", "Company name", "Company website"};
        String[] row1 = {"1", "Pallavi655496@gmail.com", "Testing software Engineer", "Frankfurt", "Need 4 yrs exp tester", "https://alchemy.hguy.co/jobs", "Alchemy", "www.Alchemy.com"};
        data.add(heading);
        data.add(row1);
    ...
    public static void main(String args[]) throws IOException {
        ...
        Activity_13 objExcelFile = new Activity_13();
